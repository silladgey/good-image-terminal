...
class Color:
    ...
    def hsv(self) -> tuple[int,...]:
        ...
        df = mx - mn
        if mx == mn: h = 0
        elif mx == self.r: h = (60 * ((self.g - self.b) / df) + 360) % 360
        elif mx == self.g: h = (60 * ((self.b - self.r) / df) + 120) % 360
        elif mx == self.b: h = (60 * ((self.r - self.g) / df) + 240) % 360
    ...
    @property
    def lab(self):
        x, y, z = [value / ref for value, ref in zip(self.xyz, (95.047, 100.000, 108.883))]
