...
from .terminal_io import UserInput, TerminalOutput, TerminalHistory
...
class TerminalGui(Element):
    ...
    def _submit_input(self, event: Any) -> None:
    ...
    def _confirm_suggestion(self, event: Any) -> None:
        value = event.target.value
    ...
    def _on_input_control_keydown(self, event: Any) -> None:
    ...
    def _focus_input(self, _event: Any) -> None:
